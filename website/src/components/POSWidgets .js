        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
            ...
            <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", color: "#a8edea" }}>
              Bothive POS Solutions
            </span>
          </div>
          <h5 className="mb-0">Built For Every Business Type</h5>
        </div>
        <small className="text-muted">8 industry verticals</small>
      </Card.Header>
      <Card.Body>
        <Row className="g-3">
...
// 6. CTA WIDGET
// ─────────────────────────────────────────────
export const POSCTAWidget = () => {
  const history = useHistory();

  return (
    <Card
      border="light"
      className="shadow-sm text-center overflow-hidden"
    ...
    >
      ...
      >
        ...
        >
          Book a free consultation and we'll map out a POS system built specifically for your
          operations — at no obligation.
        </p>
