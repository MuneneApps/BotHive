...
// ─────────────────────────────────────────────
// POS Features (lightweight fallback)
// ─────────────────────────────────────────────
export const POSFeaturesWidget = () => {
  ...
  return (
    <Card border="light" className="shadow-sm h-100">
      <Card.Body>
        <h6 style={{ fontWeight: 700, marginBottom: 12 }}>POS Features</h6>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {features.map((f, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <FontAwesomeIcon icon={faCheckCircle} style={{ color: '#0f7a76' }} />
...
export const WebsiteFeaturesWidget = () => {
  ...
  return (
    <Card border="light" className="shadow-sm h-100">
      <Card.Body>
        <h6 style={{ fontWeight: 700, marginBottom: 12 }}>Website Features</h6>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {features.map((f, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <FontAwesomeIcon icon={faCloud} style={{ color: '#185FA5' }} />
              <span style={{ color: '#333' }}>{f}</span>
            </div>
          ))}
        </div>
